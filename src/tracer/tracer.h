...
public:
    LoopFuncInfo() {}
    LoopFuncInfo(string func_name, vector<string> func_args, vector<string> func_args_type, vector<string> global_vars){
    ...
    vector<string> getFuncArgs(){
        return func_args;
    }
    vector<string> getFuncArgsType(){
        return func_args_type;
    }
    vector<string> getGlobalVars(){
        return global_vars;
    }
    int getInstanceNum(){
        return instanceNum;
    }
    SgFunctionDeclaration *getFuncDecl(){
        return func_decl;
    }
    void setFuncName(string func_name){
        this->func_name = func_name;
    }
    void setFuncArgs(vector<string> func_args){
        this->func_args = func_args;
    }
...
// This data is generated in initTracing()
    ...
    void traverseCG (SgGraphNode* CGNode, SgIncidenceDirectedGraph *CG, boost::unordered_map< SgFunctionDeclaration *, SgGraphNode * > &mapCG);
...
public:
    ...
    void moveCodeletSourcefile(string prefixStr, string funcName, string baseFileName, bool isRestore);
...
public:
    ...
    Tracer* tr;
    ParseLoopFiles(vector<string>* fileNames) {
