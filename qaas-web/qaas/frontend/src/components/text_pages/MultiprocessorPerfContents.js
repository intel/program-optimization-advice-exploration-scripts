    ...
    return (
        <div className="textPageContainer">
            ...
            <p>
                ...
                with a 40X range. From Fig. MPperf we know that all of the miniapps (except Kripke) are within 15% performance difference on SPR and ICL, and two of the whole apps have &gt; 15% performance differences.
            ...
            <p>
                ...
                Highlights of the variations in HW/SW mismatches across these codes are further explored in BQI (see below).
            </p>

            <p>
                In each case, QaaS chooses parameter values for best performance, so the variations imply potential difficulties that human developers will encounter in balancing these factors per code on each machine.
