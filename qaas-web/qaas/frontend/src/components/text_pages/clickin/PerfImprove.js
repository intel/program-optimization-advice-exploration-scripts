    ...
    return (
        <div className="textPageContainer">
            ...
            <p>
                ...
                it is important to acknowledge that all such discussions come down to two related issues:
                <ul>
                    <li>
                        Understanding a computation’s performance and
                    </li>
                    <li>
                        Automatically improving acomputation’s performance
                    </li>
            ...
            <p>
                ...
                Similarly, software choices like language, compiler, compiler flags,



                and runtime libraries used are also consequential. These options and their combinations can vary performance,


                but don’t really help a developer

                to understand why performance changes.
                <div className='container-next-to-paragraph'>
                    <p>Unless a perf tool gives automatic gains, <br />
                        it’s a computer game. <br />
                        → QaaS analyses are actionable.</p>
                </div>
            </p>

            <p>
                They are (mostly) independent variables, but the dependent variables that actually explain why performance changes often remain hidden.
                Some SW tools purport to explain more performance, but usually only offer views that may or may not matter.
                For example, if a function has a high time profile, it is not bad if the function runs at high Gf.
                Neither are relatively high cache misses if they are hidden behind lots of ALU processing.
                Understanding why the machine stalls is the key to lost time, and is the bottom line we seek.
            </p>
