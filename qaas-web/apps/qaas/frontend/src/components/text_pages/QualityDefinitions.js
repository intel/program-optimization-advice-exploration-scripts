...
export default function QualityDefinitions() {
    return (
        <div className="textPageContainer">
            <h1>A.Quality Definitions</h1>

            <p>We define quality to include performance{', '}
                <Link to="/definitions#portability">portability</Link>{', '}
                <Link to="/definitions#reliability">reliability</Link>{', '}
                <Link to="/definitions#availability">availability</Link>{', '}
                cost of operation, and related topics.
