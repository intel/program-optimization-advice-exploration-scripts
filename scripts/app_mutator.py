...
def generate_build_run_timing_scripts(run_dir, src_file, codelet_name, locus_bin_run_dir):
    ...
    return iceorig_file,locus_outfile_suffix,build_cmd_sh_file,timing_script_file,timing_fn_name
...
def exec(src_dir, compiler_dir, output_binary_path, orig_user_CC, user_CC, 
    ...
    full_iceorig_file, locus_outfile_suffix, build_cmd_sh_file, timing_script_file, timing_fn_name = generate_build_run_timing_scripts(run_dir, full_src_file, 'conv', locus_bin_run_dir)
